...
public class MovieDetailFragment extends Fragment {
    ...
    private static final String MOVIE_ID_ARG = "movieIdArgument";
    ...
    public static MovieDetailFragment newInstance(String movieId) {
        ...
        args.putString(MOVIE_ID_ARG, movieId);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            movieId = getArguments().getString(MOVIE_ID_ARG);
        }
    }
    ...
    public void onActivityCreated (Bundle savedInstanceState) {
        ...
        favoritesButton = (Button) getActivity().findViewById(R.id.movieDetailFavoriteButton);
        favoritesButton.setEnabled(false);

        databaseHelper = new MovieDetailsDatabaseHelper(getActivity());
        ...
        if (NetworkUtility.isConnected(getActivity())) {
            ...
            Toast.makeText(getActivity(), "No Internet! Connect and try again.", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void saveToFavorites() {
        ...
        Uri response = getActivity().getContentResolver().insert(FavoriteMoviesProvider.CONTENT_URI, valuesToSave);
    ...
    private void removeFromFavorites() {
        String selection = MovieDetailsDatabaseHelper.MovieDetail.COLUMN_MOVIE_ID + " = ?";
        String[] selectionArgs = {movieId};
        getActivity().getContentResolver().delete(FavoriteMoviesProvider.CONTENT_URI, selection, selectionArgs);
        updateFavoriteButton();
    }
    ...
    private void parseAndUpdateDetailsUI(String stringToParse) throws JSONException {
        ...
        TextView titleText = (TextView) getActivity().findViewById(R.id.movieDetailTextViewTitle);
        titleText.setText(title);

        TextView taglineText = (TextView) getActivity().findViewById(R.id.movieDetailTextViewTagline);
        taglineText.setText(tagline);

        ImageView imageView = (ImageView) getActivity().findViewById(R.id.movieDetailImageView);
        Picasso.with(getActivity()).load(imageUrl).into(imageView);

        TextView overviewText = (TextView) getActivity().findViewById(R.id.movieDetailTextViewOverview);
        overviewText.setText(overview);

        TextView releaseDateText = (TextView) getActivity().findViewById(R.id.movieDetailTextViewReleaseDate);
        releaseDateText.setText(releaseDate);

        //strings using formats
        TextView ratingText = (TextView) getActivity().findViewById(R.id.movieDetailTextViewRating);
        ratingText.setText(String.format(Locale.ENGLISH, "%.2f", rating));

        //for strings that require string resources
        Resources res = getResources();

        TextView runtimeText = (TextView) getActivity().findViewById(R.id.movieDetailTextViewRuntime);
        ...
        TextView budgetText = (TextView) getActivity().findViewById(R.id.movieDetailTextViewBudget);
        ...
        TextView revenueText = (TextView) getActivity().findViewById(R.id.movieDetailTextViewRevenue);
    ...
    private void parseAndUpdateTrailersUI(String stringToParse) throws JSONException {
        ...
        if (numTrailers > 0) {
            ...
            LinearLayout trailerSectionLayout = (LinearLayout) getActivity().findViewById(R.id.trailersLayout);
            ...
            for (int i = 0; i < numTrailers; i++) {
                ...
                LinearLayout trailerContainer = new LinearLayout(getActivity());
            ...
            TextView trailerSectionHeaderText = (TextView) getActivity().findViewById(R.id.movieDetailTrailerHeaderText);
    ...
    private void parseAndUpdateReviewsUI(String stringToParse) throws JSONException {
        ...
        if (numReviews > 0) {
            ...
            LinearLayout reviewSectionLayout = (LinearLayout) getActivity().findViewById(R.id.reviewsLayout);
            ...
            TextView reviewSectionHeaderText = (TextView) getActivity().findViewById(R.id.movieDetailReviewHeaderText);
